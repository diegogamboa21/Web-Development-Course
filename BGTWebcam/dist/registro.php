<?php include_once 'includes/templates/header.php' ?>
  ...
  <section class="seccion contenedor">
    ...
    <form id="registro" class="registro" action="index.html" method="post">
        ...
        <ul class="lista-precios clearfix">
          ...
          <li>
            <div class="tabla-precio">
              ...
              <div class="orden">
                <label for="paseCompleto">Boletos deseados:</label>
      ...
      <div id="resumen" class="clear resumen">
        <h3>pago y Extras</h3>
        <div class="caja clearfix">
          <div class="extras">
            <div class="orden">
              <label for="camisa_evento">Camisa del evento $10 <small>(promoción 7% desc)</small></label>
              <input type="number" min="0" id="camisa_evento" size="3" placeholder="0">
            </div>

            <div class="orden">
              <label for="etiquetas">paquete de 10 etiquetas $2 <small>(HTML5, CSS3, JavasScript,
                  Chrome)</small></label>
            ...
            <input type="button" id="calcular" value="Calcular" class="boton">
          </div>
